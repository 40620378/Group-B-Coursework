SELECT country.? AS reportName, SUM(sum_countries.totalPopulation) AS totalPopulation, SUM(sum_countries.totalCity) AS totalCity, SUM(sum_countries.totalNotCity) AS totalNotCity
FROM(
